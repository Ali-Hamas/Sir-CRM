...
import {
  Lock, Mail, User, AlertCircle, Loader2, Bot, FolderKanban,
  ShieldCheck, Sparkles, ArrowRight, Eye, EyeOff
} from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-12 bg-zinc-950 text-white antialiased overflow-hidden select-none relative">
      ...
      {/* Left Column — Brand Showcase & Account Benefits */}
      <div className="hidden lg:flex lg:col-span-6 xl:col-span-7 flex-col justify-between p-12 lg:p-16 relative z-10 border-r border-zinc-800/60 bg-gradient-to-br from-zinc-950/80 via-zinc-900/60 to-zinc-950/90 backdrop-blur-2xl">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3 pt-6 max-w-xl">
            <h2 className="text-3xl lg:text-4xl font-black tracking-tight leading-tight text-white">
              Join 10,000+ High-Performance Workspaces Today
            </h2>
            <p className="text-sm text-zinc-400 leading-relaxed">
              Create your organization account to unlock unified AI RAG document synthesis, CRM pipelines, time tracking, and team RBAC security.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 my-8 max-w-2xl">
          <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-md space-y-2 hover:border-indigo-500/40 transition-all">
            ...
            <h4 className="text-xs font-bold text-white">Instant Org Setup</h4>
            <p className="text-[11px] text-zinc-400 leading-normal">Automatic multi-tenant workspace provisioning & department configuration.</p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-md space-y-2 hover:border-purple-500/40 transition-all">
            ...
            <h4 className="text-xs font-bold text-white">CRM & Operations</h4>
            <p className="text-[11px] text-zinc-400 leading-normal">Integrated deal pipelines, client management, and document vault.</p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-md space-y-2 hover:border-blue-500/40 transition-all">
            ...
            <p className="text-[11px] text-zinc-400 leading-normal">Strict roles, permissions, and administrative security controls.</p>
          </div>
        </div>

        {/* Footer */}
        <div className="flex items-center justify-between pt-6 border-t border-zinc-800/80 max-w-2xl text-xs text-zinc-400">
          <span className="font-semibold text-zinc-200">100% Free Organization Trial</span>
          <span className="text-zinc-500">•</span>
          <span className="font-medium text-zinc-300">No Credit Card Required</span>
        </div>
      </div>

      {/* Right Column — Deluxe Registration Form Card */}
      <div className="lg:col-span-6 xl:col-span-5 flex flex-col justify-center items-center p-6 sm:p-10 lg:p-12 relative z-10">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="lg:hidden text-center mb-6">
            ...
            <p className="text-xs text-zinc-400 mt-1">Create your enterprise account</p>
          </div>

          {/* Form Header */}
          <div className="space-y-1 text-center lg:text-left">
            <h2 className="text-2xl lg:text-3xl font-black tracking-tight text-white">Create Account</h2>
            <p className="text-xs text-zinc-400">Get started with your BlackDesk OS workspace today.</p>
          </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    ...
                    {errors.firstName && (
                      <p className="text-[11px] text-red-400 mt-1 font-medium">{errors.firstName.message}</p>
                    )}
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    {errors.lastName && (
                      <p className="text-[11px] text-red-400 mt-1 font-medium">{errors.lastName.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      {...register('email')}
                      type="email"
                      placeholder="shaheer@company.com"
